<div class="w-full flex justify-center py-10">
    <div class="bg-white w-full max-w-4xl rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
        <div class="p-8 border-b border-gray-50 bg-white">
            <h1 class="text-2xl font-bold text-gray-800">Nova Questao</h1>
        ...
        <form wire:submit.prevent="save" class="p-8 space-y-6">
            ...
            <div class="flex justify-end gap-4 pt-6 border-t border-gray-50">
                ...
                <button type="submit" class="bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold py-2.5 px-6 rounded-xl transition shadow-lg shadow-indigo-100">Salvar Questao</button>
            </div>
        </form>
    </div>
</div>
